...
export default function JobCard({ job, distanceMi, onPress, onBid }: Props) {
...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 14, fontWeight: '600', color: theme.colors.text, marginRight: 10 },
  price: { fontSize: 15, fontWeight: '600', color: theme.colors.text },
  meta: { fontSize: 11, color: theme.colors.muted, marginTop: 4 },
  ...
  bidText: { color: theme.colors.primaryText, fontSize: 13, fontWeight: '600' },
});
